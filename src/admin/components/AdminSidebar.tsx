            ...
            <div className="flex items-center gap-3 overflow-hidden">
              ...
              {(!collapsed || mobileOpen) && (
                <div className="flex flex-col truncate">
                  <span className="font-semibold text-base text-ink tracking-tight">Cedarview</span>
                ...
                >
                  <Icon
                    className={cn(
                      ...
                      isActive ? 'text-emerald-300' : 'text-ink-soft group-hover:text-teal-deep'
                    )}
                  />
                  ...
                  {item.badge !== null && (
                    <Badge
                      ...
                      className={cn(
                        ...
                        collapsed && !mobileOpen && 'absolute top-1 right-1 px-1.5 py-0 text-[10px]'
                      )}
                    >
                      {item.badge}
                    </Badge>
      ...
      <div className="p-3 border-t border-line space-y-3">
        {!collapsed && (
          ...
          >
            ...
            <span className="text-[10px] text-ink-soft/60 group-hover:underline">Open tab</span>
          </Link>
        )}
